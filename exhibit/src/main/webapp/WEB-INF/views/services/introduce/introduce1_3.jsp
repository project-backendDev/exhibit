...
<body class="Pretendard">
    ...
    <div class="sub_visu" style="background: url(${pageContext.request.contextPath }/assets/images/profile_bg.png) no-repeat 30% center;">
        <div class="wrap">
            <div class="txt">
                <h2>프로필</h2>
	...
	<div class="content">
                        ...
                        <li>
                            <div class="left">
                                ...
                                <div class="txt">
                                    ...
                                    <p>
                                        ...
                                        1991 제1회를 시작으로 매 의료 발전, 국민건강향상 등에 기여한<br class="pc_only">
                                        사람을 선정하고 있음                                        
                                    </p>
                                </div>
                            </div>
                            <div class="right">
                                ...
                                <div class="txt">
                                    <h5>심청효행상</h5>
                                    <p>
                                        1999 인천 옹진군 백령도에 심청동상과 심청각을 기증한 것을 계기로<br class="pc_only">
                                        시작. 2018에 20회를 맞았으며, 매 전국의 효녀, 다문화 효부, 다문화<br class="pc_only">
                                        가정을 돕는 단체를 선정하여 시상하고 있음.                                        
                                    </p>
                                </div>
                            </div>
                        </li>
                        ...
                        <li>
                            <div class="left">
                                ...
                                <div class="txt">
                                    <h5>전북교육대상</h5>
                                    <p>
                                        1997 제정하여 가천문화재단과 전북도민일보가 공동으로 주최. <br class="pc_only">
                            ...
                            <div class="right">
                                ...
                                <div class="txt">
                                    <h5>한센국제협력후원회</h5>
                                    <p>
                                        지난 92 발족한 후원회를 1993 7월부터 한센국제협력후원회 회장을 <br class="pc_only">
                                        맡아오고 있음. 베트남 한센 환우들의 치료와 재활을 지원해주고 있으며,<br class="pc_only">
                                        2001 12월에는 베트남 빈딘성에 직업훈련원을 건립했음.                                      
                                    </p>
                                </div>
                            </div>
                        </li>
                        ...
                        <li>
                            <div class="left">
                                ...
                                <div class="txt">
                                    <h5>새생명찾아주기운동본부</h5>
                                    <p>
                                        지난 1992 5월 새생명찾아주기운동본부 설립,<br class="pc_only">
                                        현재 사회복지법인으로 전환한 운동본부의 이사장을 맡고 있음.<br class="pc_only">
                                        심장병 환자들의 무료 진료 지원.                             
                                    </p>
                                </div>
                            </div>
                            <div class="right">
                                <div class="dot"></div>
                                <div class="txt">
                                    <h5>가천미추홀청소봉사단<span>(초대총재)</span></h5>
                                    <p>
                                        지난 93 창단과 함께 초대 총재를 맡은 뒤 95 이후 명예총재로 활동.<br class="pc_only">
                                        청소봉사활동을 수행하며 청소자원봉사센터와 청소 수련관 등을 <br class="pc_only">
                                        위탁 운영하고 있음.  
                                    </p>
                                </div>
                            </div>
                        ...
                        <li>
                            <div class="left">
                                ...
                                <div class="txt">
                                    <h5>청소보호위원회 위원</h5>
                                    <p>
                                        2002 6월부터 청소보호위원회 위원으로 위촉됐음.<br class="pc_only">
                                        지난 98 창설되어 매 대한민국 청소보호대상을 시상해오고 있음<br class="pc_only">                    
                                    </p>
                                </div>
                            </div>
                            <div class="right">
                                ...
                                <div class="txt">
                                    ...
                                    <p>
                                        여성권익 신장을 위해 1999부터 길병원에서 신생아가 1명 태어날 <br class="pc_only">
                                        때마다 일정액을 적립해 기탁.
                                    </p>
                                </div>
                            </div>
		...
		<!-- <div class="award_history">
			<div class="wrap">
				<h2>상훈</h2>
				<div class="box">
					<div class="img"><img src="${pageContext.request.contextPath }/assets/images/profile6.png" alt=""></div>
					<div class="txt">
						<h3>2010<span>年代</span></h3>
						<div class="list">
							<ul class="left">
								<li><span>· 2020</span>국제라이온스 인도주의상 수상<br/>한국경영학회 명예의전당 헌액</li>
								<li><span>· 2019</span>제16회 서재필의학상 수상</li>
								<li><span>· 2018</span>성남시 표창</li>
								<li><span>· 2017</span>제1회 대한민국을 빛낸 호남인상 수상<br/>올해의 인천인대상</li>
								<li><span>· 2016</span>한국여자의사회 공로상 및 특별기여상 수상<br/>한국여성지도자상 대상</li>
								<li><span>· 2015</span>키르기스스탄 최고 의료훈장 수훈</li>
							</ul>
							<ul class="right">
								<li><span>· 2013</span>포브스(FORBES) '아시아 기부 영웅 48인' 선정<br/>미국 하와이한인회 '한인이주 110주년 기념식' 공로패</li>
								<li><span>· 2012</span>인촌상 '공공봉사부문' 수상<br/>뉴스위크 '2012 세계를 움직이는 여성 150인' 선정</li>
								<li><span>· 2011</span>한국과학기자협회, 우남 과학진흥상<br/>여성신문사 '올해의 인물상' 수상</li>
								<li><span>· 2010</span>제1회 인천사랑대상 수상</li>
							</ul>
						</div>
					</div>
				</div>
				<div class="box">
					<div class="img"><img src="${pageContext.request.contextPath }/assets/images/profile7.png" alt=""></div>
					<div class="txt">
						<h3>2010<span>年代</span></h3>
						<div class="list">
							<ul class="left">
								<li><span>· 2009</span>
									과학기술훈장 창조장(1등급)<br/>
									제12회 효령상 사회봉사부문 수상<br/>
									제3회 성산효행대상 수상<br/>
									몽골 최고 훈장 '훔테트 템테그 의료훈장'								
								</li>
								<li><span>· 2007</span>
									'2007 자랑스런 한국인 대상' 수상<br/>
									서울의대 제정 제8회 함춘대상 사회공헌부문 대상 수상								
								</li>
								<li><span>· 2006</span>
									서울대 총동창회 ‘유공(有功)동문상’ 수상<br/>
									2006 대한민국「가장 존경받는 경영인 賞」수상								
								</li>
							</ul>
							<ul class="right">
								<li><span>· 2003</span>
